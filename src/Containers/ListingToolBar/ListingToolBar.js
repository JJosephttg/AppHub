    ...
    return (
        <div className={styles["toolbar-container"]}>  
            ...
            <div className={[styles["right-container"], styles.container].join(" ")}>
                <button className={["btn btn-primary", styles.iconSizeFont].join(" ")}>+</button>
                <button className={["btn btn-secondary", styles.iconSizeFont].join(" ")}>
                <svg width=".7em" height=".7em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className={["btn btn-danger", styles.iconSizeFont].join(" ")}>
                    <svg width=".7em" height=".7em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
